  ...
  return (
    <ScrollView className="bg-background-primary flex-1 h-screen" style={{ height: Dimensions.get('screen').height }}>
      ...
      >
        ...
        <View>
          <LottieView
            source={require('@/src/assets/animations/save-password.json')}
            autoPlay
            loop={false}
        ...
        <View className="px-5">
          <Text className="text-2xl font-NunitoBold text-foreground-primary text-center">Password changed!</Text>
